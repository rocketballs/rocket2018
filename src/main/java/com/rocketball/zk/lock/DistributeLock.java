package com.rocketball.zk.lock;
...
public class DistributeLock implements Lock, Watcher {
    ...
    public static void main(String[] args) {
        DistributeLock lock = new DistributeLock("zookeeper://newsrec41.xs.163.org:2181?backup=newsrec42.xs.163.org:2181,newsrec43.xs.163.org:2181,newsrec44.xs.163.org:2181,newsrec50.xs.163.org:2181", "lock");
        lock.lock();
        //共享资源
        if (lock != null)
            lock.unlock();
