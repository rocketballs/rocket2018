...
public class SubscribeZkClient {
    private static final int  CLIENT_QTY = 5;  //模拟workserver数量

    private static final String  ZOOKEEPER_SERVER = "newsrec41.xs.163.org:2181";
    ...
    public static void main(String[] args) throws Exception{
        ...
        try
        {
            ...
            for ( int i = 0; i < CLIENT_QTY; ++i )
            {
                ...
                serverData.setIpAddr("192.168.100."+i);
